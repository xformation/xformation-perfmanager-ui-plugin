...
export class EditToCollectorPopup extends React.Component<any, any> {
    ...
    onUpdate = async (event: any) => {
        ...
        axios.put(config.UPDATE_CATALOG, cd, {})
            .then((response: any) => {
                ...
                <ModalBody style={{ height: 'calc(48vh - 0px)', overflowY: 'auto', overflowX: "hidden" }}>
                    <div className="catalog-form-group">
                        <div className="form-group">
                            ...
                            <input type="text" placeholder="" name="catalogName" id="catalogName" value={this.state.catalogName} onChange={this.handleStateChange} className="input-group-text" />
                            <span style={{color:'red'}}>{this.state.catlogNameRequired}</span>
                        </div>
                        <div className="form-group">
                            <label htmlFor="CatalogType">Catalog Type</label>
                            <select className="form-control primary-select-box" name="type" id="type" onChange={this.onChangeSelectBox} value={this.state.type} >
                        ...
                        <div className="form-group">
                            ...
                            <textarea name="catalogDescription" className="input-group-text" id="catalogDescription" onChange={this.handleStateChange} value={this.state.catalogDescription}></textarea>
                            <span style={{color:'red'}}>{this.state.catalogDescriptionRequired}</span>
                        </div>
                        <div>
                            <button className="btn btn-secondary m-r-2" onClick={this.onUpdate} >Update</button>
